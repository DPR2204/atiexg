        ...
        <section className="relative py-20 lg:py-28 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center animate-fade-in-up">
            ...
            <p className="text-lg text-gray-500 leading-relaxed max-w-2xl mx-auto">
              Todo lo que necesitas saber antes de tu aventura en el Lago de Atitlan.
              Si no encuentras tu respuesta, escribenos por WhatsApp.
            </p>
          </div>
        </section>
            ...
            <div className="relative glass-card rounded-[2.5rem] overflow-hidden">
              ...
              <div className="relative px-8 py-14 sm:px-14 sm:py-20 text-center">
                ...
                <p className="text-white/70 max-w-xl mx-auto mb-8">
                  Nuestro equipo esta disponible por WhatsApp para resolver cualquier duda
                  sobre tu proxima aventura en el Lago de Atitlan.
                </p>
                <a
