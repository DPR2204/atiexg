...
// Descriptive titles and categories for gallery images
const IMAGE_TITLES: Record<string, { title: string; category: string }> = {
  'DSC03855_rixhas': { title: 'Atardecer en el Mirador', category: 'Paisajes' },
  'DSC03858_qvws23': { title: 'Siluetas al Ocaso', category: 'Paisajes' },
  'DSC03863_hetwpl': { title: 'Hora Dorada sobre el Lago', category: 'Paisajes' },
  'DSC03989_ywaz7j': { title: 'Vista Panorámica del Volcán', category: 'Paisajes' },
  'DSC03997_qlzxrn': { title: 'Mirador hacia el Volcán', category: 'Paisajes' },
  'DSC04002_sfqosk': { title: 'Contemplando el Lago', category: 'Aventura' },
  'DSC04004_hcety6': { title: 'Sendero con Vista al Volcán', category: 'Aventura' },
  'DSC04010_fkeh6v': { title: 'Siluetas en el Restaurante', category: 'Gastronomía' },
  'DSC04016_cw8qco': { title: 'Atardecer desde la Terraza', category: 'Paisajes' },
  'DSC04019_ox7ytu': { title: 'Lago al Atardecer', category: 'Paisajes' },
  'DSC04023_zfkjq7': { title: 'Reflejos en el Agua', category: 'Paisajes' },
  'DSC04025_x0dtae': { title: 'Volcán entre las Nubes', category: 'Paisajes' },
  'DSC04033_kq63ay': { title: 'Café y Artesanías', category: 'Cultural' },
  'DSC04037_hi3wgr': { title: 'Marimba Tradicional', category: 'Cultural' },
  'DSC04040_u4tqs5': { title: 'Músicos en Traje Típico', category: 'Cultural' },
  'DSC04042_ktnwye': { title: 'Textiles Mayas', category: 'Cultural' },
  'DSC04045_etlucg': { title: 'Colores del Mercado', category: 'Cultural' },
  'DSC04046_whihtj': { title: 'Artesanías de Guatemala', category: 'Cultural' },
  'DSC04051_qs4st8': { title: 'Calle Típica de Colores', category: 'Cultural' },
  'DSC04052_zyoxm8': { title: 'Mural Cosmogónico Maya', category: 'Cultural' },
  'DSC04054_skmjsn': { title: 'Paseo de los Sombreros', category: 'Cultural' },
  'DSC04055_mhf1ao': { title: 'Calle Decorada', category: 'Cultural' },
  'DSC04056_bfizey': { title: 'Fachadas de Colores', category: 'Cultural' },
  'DSC04058_ljybdj': { title: 'Arte Callejero en el Pueblo', category: 'Cultural' },
  'DSC04061_btxfjc': { title: 'Mural de la Naturaleza', category: 'Cultural' },
  'DSC04063_bompv3': { title: 'Vida en el Pueblo', category: 'Cultural' },
  'DSC04064_nlwvxb': { title: 'Calles Empedradas', category: 'Cultural' },
  'DSC04071_aktxhg': { title: 'Iglesia Colonial', category: 'Cultural' },
  'DSC04073_teixpq': { title: 'Plaza del Pueblo', category: 'Cultural' },
  'DSC04081_pc3eoc': { title: 'Mercado de Artesanías', category: 'Cultural' },
  'DSC04089_rahsad': { title: 'Vendedora de Textiles', category: 'Cultural' },
  'DSC04090_wrgixg': { title: 'Pueblo y Volcán Panorámica', category: 'Paisajes' },
  'DSC04094_vht4pi': { title: 'Vista del Lago desde el Pueblo', category: 'Paisajes' },
  'DSC04101_ktjtcp': { title: 'Escaleras al Mirador', category: 'Aventura' },
  'DSC04114_bjxcf6': { title: 'Panorámica de Panajachel', category: 'Paisajes' },
  'DSC04115_p7kzgl': { title: 'Costa del Lago', category: 'Paisajes' },
  'DSC04116_qt2mjq': { title: 'Lanchas en la Orilla', category: 'Paisajes' },
  'DSC04119_oadxam': { title: 'Muelle de Panajachel', category: 'Paisajes' },
  'DSC04135-HDR_gyllyu': { title: 'Volcán al Amanecer', category: 'Paisajes' },
  'DSC04155_oftlcp': { title: 'Ribera del Lago', category: 'Paisajes' },
  'DSC04160_ajbk7r': { title: 'Muelle al Atardecer', category: 'Paisajes' },
  'DSC04170_dswiko': { title: 'Embarcadero con Gaviotas', category: 'Paisajes' },
  'DSC04174_gnacgl': { title: 'Puente sobre el Río', category: 'Paisajes' },
  'DSC04177_tcgwam': { title: 'Sendero junto al Agua', category: 'Aventura' },
  'DSC04183_g7ffkv': { title: 'Pier al Anochecer', category: 'Paisajes' },
  'DSC04185_rgqgug': { title: 'Cielo Nublado sobre el Lago', category: 'Paisajes' },
  'DSC04188_gpbth7': { title: 'Navegando el Lago', category: 'Aventura' },
  'DSC04192_yvloo0': { title: 'Vista desde la Lancha', category: 'Aventura' },
  'DSC04193_obgcum': { title: 'Volcanes y Nubes', category: 'Paisajes' },
  'DSC04194_panqpm': { title: 'Aguas Cristalinas', category: 'Paisajes' },
  'DSC04199_de2elm': { title: 'Travesía por el Lago', category: 'Aventura' },
  'DSC04200_h0ije3': { title: 'Pueblo a la Orilla', category: 'Paisajes' },
  'DSC04201_xxscdr': { title: 'Interior de la Iglesia', category: 'Cultural' },
  'DSC04206_ainpux': { title: 'Santos Vestidos de Gala', category: 'Cultural' },
  'DSC04210_utgfk1': { title: 'Altar con Telas Verdes', category: 'Cultural' },
  'DSC04213_y7d6xs': { title: 'Devotas en la Iglesia', category: 'Cultural' },
  'DSC04213-2_nw4evi': { title: 'Tradiciones Religiosas', category: 'Cultural' },
  'DSC04216_v998mf': { title: 'Ceremonia en el Templo', category: 'Cultural' },
  'DSC04218_lluvgq': { title: 'Rituales Mayas', category: 'Cultural' },
  'DSC04226_xwlrkb': { title: 'Calle con Volcán de Fondo', category: 'Paisajes' },
  'DSC04235_vi1v0p': { title: 'Paisaje Volcánico', category: 'Paisajes' },
  'DSC04238_swyart': { title: 'Volcán y Vegetación', category: 'Paisajes' },
  'DSC04269_oyeeuc': { title: 'Retrato junto al Lago', category: 'Aventura' },
  'DSC04286_dnfvaq': { title: 'Pareja en las Rocas', category: 'Aventura' },
  'DSC04291_k4ew5f': { title: 'Picnic frente al Lago', category: 'Gastronomía' },
  'DSC04336_bqmz9o': { title: 'Brindis con Vista', category: 'Gastronomía' },
  'DSC04359_kkmswv': { title: 'Tabla de Quesos y Vino', category: 'Gastronomía' },
  'DSC04361_iuucat': { title: 'Sunset Cruise', category: 'Aventura' },
  'DSC04363_dt2vuy': { title: 'Navegando al Atardecer', category: 'Aventura' },
  'DSC04369_mpx3ng': { title: 'Brisa del Lago', category: 'Paisajes' },
  'DSC04374_rdep9d': { title: 'Volcán San Pedro', category: 'Paisajes' },
  'DSC04375_tnkr74': { title: 'Caminata en la Reserva', category: 'Aventura' },
  'DSC04379_sgrb2n': { title: 'Paseo por el Parque', category: 'Aventura' },
  'DSC04381_ro3yne': { title: 'Sendero entre los Árboles', category: 'Aventura' },
  'DSC04382_lsaau0': { title: 'Camino Natural', category: 'Aventura' },
  'DSC04387_zcq91s': { title: 'Puente Colgante', category: 'Aventura' },
  'DSC04392_eo9djb': { title: 'Naturaleza de Atitlán', category: 'Paisajes' },
  'DSC04401_isltck': { title: 'Reserva Natural', category: 'Aventura' },
  'DSC04406_cwmb3x': { title: 'Flora del Lago', category: 'Paisajes' },
  'DSC04409_s9fcdx': { title: 'Vegetación Tropical', category: 'Paisajes' },
  'DSC04414_ziuyjw': { title: 'Jardines de Panajachel', category: 'Paisajes' },
  'DSC04420_he9crp': { title: 'Reserva con Vista al Lago', category: 'Aventura' },
  'DSC04422_ykofei': { title: 'Cascada Escondida', category: 'Aventura' },
  'DSC04424_tyaqfw': { title: 'Mirador de la Reserva', category: 'Aventura' },
  'DSC04437_qbd9yg': { title: 'Vuelo del Quetzal', category: 'Aventura' },
  'DSC04440_r9skha': { title: 'Pareja Aventurera', category: 'Aventura' },
  'DSC04443_icsgib': { title: 'Zipline sobre el Bosque', category: 'Aventura' },
  'DSC04444_uppybw': { title: 'Aventura en el Dosel', category: 'Aventura' },
  'DSC04445_q87jar': { title: 'Puente de Aventura', category: 'Aventura' },
  'DSC04451_gbforf': { title: 'Vista desde las Alturas', category: 'Paisajes' },
  'DSC04454_mrhxxv': { title: 'Montañas y Nubes', category: 'Paisajes' },
  'DSC04458_jh82ac': { title: 'Paisaje de Ensueño', category: 'Paisajes' },
  'DSC04462_gvstdy': { title: 'Retrato en Atitlán', category: 'Cultural' },
  'DSC04464_flabb8': { title: 'Amanecer en el Lago', category: 'Paisajes' },
  'DSC04466_mxfzds': { title: 'Volcanes de Guatemala', category: 'Paisajes' },
  'DSC04470_i6h83r': { title: 'Colores del Atardecer', category: 'Paisajes' },
  'DSC04490_eqqgtz': { title: 'Cielos de Atitlán', category: 'Paisajes' },
  'DSC04496_noiz4x': { title: 'Última Luz del Día', category: 'Paisajes' },
  'DSC04503_mb5wi7': { title: 'Noche en el Lago', category: 'Paisajes' },
};
...
const GALLERY_IMAGES = cloudinaryAssets.map((asset, index) => ({
  ...
  category: IMAGE_TITLES[asset.public_id]?.category || 'Atitlán',
  aspect: (asset.width / asset.height) > 1.2 ? 'landscape' : (asset.width / asset.height) < 0.8 ? 'portrait' : 'square',
  title: IMAGE_TITLES[asset.public_id]?.title || 'Lago de Atitlán',
