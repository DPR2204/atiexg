...
const CONTACT_METHODS = [
  {
    ...
    title: 'WhatsApp',
    description: 'Respuesta rápida, disponible 8am - 8pm',
      ...
      <main id="main-content" className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-6">
            ...
            <span className="text-xs font-semibold text-gray-600">Disponibles para ti</span>
          </div>
          ...
          <p className="text-lg text-gray-500">
            Escríbenos para cotizar tours privados, experiencias gastronómicas o programas corporativos.
            Nuestro equipo responde rápido y con opciones claras.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          ...
          <div className="glass-card rounded-3xl p-6 sm:p-8 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-500">Operamos desde el corazón del lago</p>
              </div>
            </div>
          ...
          <div className="glass-card rounded-3xl p-6 sm:p-8 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-1">Horario de Atención</h3>
            ...
            <div className="space-y-4 pl-16">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Sábado - Domingo</span>
                <span className="text-gray-900 font-bold">8:00 AM - 6:00 PM</span>
              </div>
              <div className="pt-2 border-t border-gray-100">
                <span className="text-xs text-gray-400">* Tours pueden comenzar más temprano según la experiencia</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="glass-card rounded-[2.5rem] p-8 sm:p-12 lg:p-16 text-center bg-gradient-to-br from-red-50 to-orange-50 animate-fade-in-up">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-500 mb-8">
              No te preocupes. Escríbenos por WhatsApp y te ayudaremos a encontrar la experiencia perfecta o a crear una a tu medida.
            </p>
